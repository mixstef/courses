...
// compile with:  gcc -Wall -O2 -pthread mmult-double-pthreads.c -o mmult-double-pthreads -DN=1000 -DTHREADS=4
...
void *thread_func(void *args) {
  ...
  // matrix multiplication (one "band" of A and C rows per thread)
