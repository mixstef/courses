...
class MyParser():
    ...
    def Lterm_tail(self):
        ...
        elif self.next_symbol.token in (')','{','}','id','print','if','while',None):
            # Lterm_tail → ε
            return

        else:
            raise ParseError(f'Syntax error at line {self.next_symbol.lineno} char {self.next_symbol.charpos}: In Lterm_tail(), expecting or, ), {{, }}, id, print, if, while, EOT, found {self.next_symbol.token} instead')
    ...
    def Lfactor_tail(self):
        ...
        elif self.next_symbol.token in (')','{','}','or','id','print','if','while',None):
            # Lfactor_tail → ε
            return

        else:
            raise ParseError(f'Syntax error at line {self.next_symbol.lineno} char {self.next_symbol.charpos}: In Lfactor_tail(), expecting and, or, ), {{, }}, id, print, if, while, EOT, found {self.next_symbol.token} instead')
    ...
    def Rest(self):
        ...
        elif self.next_symbol.token in (')','{','}','or','and','id','print','if','while',None):
            # Lfactor_tail → ε
            return

        else:
            raise ParseError(f'Syntax error at line {self.next_symbol.lineno} char {self.next_symbol.charpos}: In Rest(), expecting relop and, or, ), {{, }}, id, print, if, while, EOT, found {self.next_symbol.token} instead')
