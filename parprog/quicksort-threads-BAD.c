// Threaded quicksort implementation - BAD: uncontrollable thread number!
// compile with: gcc -O2 -Wall -pthread quicksort-threads-BAD.c -o quicksort-threads-BAD -DN=10000000
