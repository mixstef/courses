// Sample vector addition performed on GPU, 1 thread/1 block.
// Compile with: nvcc vectoradd-float-single-thread.cu -o vectoradd-float-single-thread -DN=10000000
