...
// NOTE: this version is inefficient due to high thread divergence!

// Compile with: nvcc sum-reduction-float-block-reduction1.cu -o sum-reduction-float-block-reduction1 -DN=10000000
