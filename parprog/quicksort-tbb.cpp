// C++ simple TBB quicksort implementation
// compile with: g++ -Wall -O2 -std=c++11 quicksort-tbb.cpp -o quicksort-tbb $(pkg-config --libs --cflags tbb)
